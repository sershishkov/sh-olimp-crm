...
const GroupOfImage = require('../../../models/mainInformation/osbb/GroupOfImage');
const PhotoWork = require('../../../models/mainInformation/osbb/PhotoWork');
...
exports.deleteImageGroup = asyncHandler(async (req, res, next) => {
  const relatedElement = await PhotoWork.findOne(
