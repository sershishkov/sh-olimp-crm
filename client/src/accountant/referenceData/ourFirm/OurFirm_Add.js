...
import { add_OUR_FIRM } from '../../../store/actions/accountant/referenceData/ourFirm';
...
const OurFirm_Add = ({
  ...
  useEffect(() => {
    setNameOfPage('Создать нашу фирму');
    getAll_TYPE_OF_SETTLEMENTS();
    getAll_CITYS();
    getAll_TYPE_OF_STREETS();
    getAll_STREETS();
...
OurFirm_Add.propTypes = {
  setNameOfPage: PropTypes.func.isRequired,
  add_OUR_FIRM: PropTypes.func.isRequired,
